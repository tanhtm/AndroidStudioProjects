...
import com.myandroid.tuanh.myvocabulary.gameofvoca.CorrectCharacters;
...
public class GameCCActivity extends AppCompatActivity {
    ...
    private void play()
    {
        ...
        correctCharacters.createButtonChoose();
    }
    private void create()
    {
    ...
    private class LoadData extends AsyncTask<Void,String,String>
    {
        ...
        protected String doInBackground(Void... voids) {
            ...
            createDB();
            FolderDB folderDB = new FolderDB(GameCCActivity.this);
            MyFolder myFolder = folderDB.getFolder(idF);
            toolbar.setTitle("Đuổi từ- Bắt chữ ( "+ myFolder.getName()+" )");
            WordProDB wordDB= new WordProDB(GameCCActivity.this);
        ...
        protected void onPostExecute(String s) {
            ...
            buttonStart.startAnimation(AnimationUtils.loadAnimation(GameCCActivity.this,R.anim.ssss));
        }
    }
